# yaneuraou-wasm-pthread-kp256 — internal spec for LLM consumers
...
- npm scope: `@ultemica/yaneuraou-wasm-pthread-kp256-hlsl`
...
- Memory ceiling is 1 GB (vs 128 MB on cfworkers). HalfKP eval still does
  not fit a typical KP256 engine binary, but `USI_Hash` can be raised
