# @ultemica/yaneuraou-wasm-pthread-kp256-hlsl
...
YaneuraOu NNUE KP256 将棋エンジンを multi-thread (pthread) で動かすための
ブラウザ向け WASM パッケージ。
...
| | `yaneuraou-wasm-cfworkers` | `yaneuraou-wasm-pthread-kp256` (this) |
|---|---|---|
...
```ts
import { createEngine } from "@ultemica/yaneuraou-wasm-pthread-kp256-hlsl";
import YaneuraOuFactory from "@ultemica/yaneuraou-wasm-pthread-kp256-hlsl/engine";
import wasmUrl from "@ultemica/yaneuraou-wasm-pthread-kp256-hlsl/wasm?url";
...
|---|---|---|---|
| suishopetite nn.bin | KP256 | 873 KB | 本パッケージに対応する評価関数 |
