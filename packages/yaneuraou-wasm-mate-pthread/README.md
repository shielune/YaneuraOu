...
| | `yaneuraou-wasm-mate-cfworkers` | `yaneuraou-wasm-mate-pthread` (this) |
|---|---|---|
...
custom headers), use `yaneuraou-wasm-mate-cfworkers` instead.

## Usage (browser)

```ts
import { createMateEngine } from "@ultemica/yaneuraou-wasm-mate-pthread";
import YaneuraOuFactory from "@ultemica/yaneuraou-wasm-mate-pthread/engine";
import wasmUrl from "@ultemica/yaneuraou-wasm-mate-pthread/wasm?url";
...
- [`@ultemica/yaneuraou-wasm-mate-cfworkers`](https://github.com/tsshogi/YaneuraOu) — single-thread variant for Cloudflare Workers and headers-restricted browsers
- [`@ultemica/yaneuraou-wasm-cfworkers`](https://github.com/tsshogi/YaneuraOu) — NNUE play engine (single-thread)
