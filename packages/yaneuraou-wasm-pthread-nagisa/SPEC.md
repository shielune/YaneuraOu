...
- NNUE architecture: `NAGISA V3.1 SFNN HalfKA_hm2_1024x2_15_64` (NAGISA V3.1 互換)
- Linker flags (em++):
...
- Memory ceiling is 2 GB (vs 128 MB on cfworkers). `USI_Hash` can be raised
  significantly (64–512 MB) along with the NAGISA V3.1 evaluator footprint.
- NNUE eval must follow the `NAGISA V3.1 SFNN HalfKA_hm2_1024x2_15_64` layout — Suisho5 系の
  `HalfKP_256x2_32_32` 重みや KP256 重みは互換性なし。NAGISA V3.1 公式 Release
