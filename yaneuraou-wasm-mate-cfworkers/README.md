...
The flagship `@ultemica/yaneuraou-wasm-cfworkers` package ships the NNUE search engine for normal play. That engine cannot solve tsume. This package ships **only the mate solver** and is much smaller (~560KB wasm).
...
import { createMateEngine } from "@ultemica/yaneuraou-wasm-mate-cfworkers";
import YaneuraOuFactory from "@ultemica/yaneuraou-wasm-mate-cfworkers/engine";
import wasmBinary from "@ultemica/yaneuraou-wasm-mate-cfworkers/wasm";
...
- [`@ultemica/yaneuraou-wasm-cfworkers`](https://github.com/tsshogi/YaneuraOu) — the NNUE play engine
