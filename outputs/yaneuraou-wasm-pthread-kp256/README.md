...
```ts
import { createEngine } from "@ultemica/yaneuraou-wasm-pthread-kp256";
import YaneuraOuFactory from "@ultemica/yaneuraou-wasm-pthread-kp256/engine";
import wasmUrl from "@ultemica/yaneuraou-wasm-pthread-kp256/wasm?url";
