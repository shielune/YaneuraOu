# yaneuraou-mate-pthread — internal spec for LLM consumers
...
`yaneuraou-mate-cfworkers/SPEC.md` (single-thread variant).
...
Identical to `yaneuraou-mate-cfworkers/SPEC.md` except:
