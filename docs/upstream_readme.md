...
yaneurao/YaneuraOu 本家の README をそのまま保存したもの。
このフォークについては [`../README.md`](../README.md) を参照。
...
[![やねうら王プロジェクトを支援する](yaneuraou-sponsors-banner.png "支援バナー")](https://github.com/sponsors/yaneurao)
